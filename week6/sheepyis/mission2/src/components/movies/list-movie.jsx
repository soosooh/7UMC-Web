            ...
            <ListContainer>
                {new Array(8).fill(null).map((_, index) => (
                    <SkeletonItem key={index}>
                        <div style={{ width: "100%", height: "10vw", backgroundColor: colors.navBackground }}></div>
                        <div style={{ marginTop: "0.5vw", height: "0.75vw", backgroundColor: colors.navBackground }}></div>
