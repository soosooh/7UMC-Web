...
const FormContainer = styled.div`
  ...
  @media (max-width: 768px) {
    max-width: 400px; /* 태블릿에서 너비 줄이기 */
  }

  @media (max-width: 480px) {
    max-width: 100%; /* 모바일에서는 100% 너비로 꽉 채우기 */
...
const ErrorText = styled.p`
  ...
  @media (max-width: 768px) {
    font-size: 12px; /* 작은 화면에서 오류 메시지 크기 줄이기 */
  }
`;
...
const SignupButton = styled.input`
  ...
  @media (max-width: 768px) {
    height: 45px; /* 작은 화면에서 버튼 크기 줄이기 */
    font-size: 14px; /* 작은 화면에서 버튼 텍스트 크기 줄이기 */
  }

  @media (max-width: 480px) {
    height: 40px; /* 모바일 화면에서 버튼 크기 줄이기 */
    font-size: 12px; /* 모바일에서 버튼 텍스트 크기 더 줄이기 */
  }
`;
