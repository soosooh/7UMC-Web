...
import { fetchNowPlayingMovies } from '../api/movie'; // API 호출 함수 임포트
...
const Container = styled.div`
    ...
    margin-top: 50px;
    min-height: 100vh; /* 화면 전체를 차지하도록 */
`;

const MovieGrid = styled.div`
    display: grid;
    grid-template-columns: repeat(auto-fill, minmax(120px, 1fr)); /* 카드 크기 조정 */
    gap: 20px; /* 카드 간격 */
`;
